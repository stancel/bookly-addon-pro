...
<div id="bookly-tbs" class="bookly-js-cancellation-confirmation">
    <div class="bookly-js-cancellation-confirmation-buttons">
        <a href="<?php echo admin_url( 'admin-ajax.php?action=bookly_cancel_appointment&token=' . $token ) ?>" class="bookly-btn-default" style="float: left; background-color: #fff !important; border-color: #b1bbc4 !important; width: auto; margin-right: 12px">
            <span style="color: #212529 !important;"><?php esc_html_e( 'Confirm cancellation', 'bookly' ) ?></span>
        </a>
