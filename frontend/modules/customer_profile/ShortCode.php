...
class ShortCode extends BooklyLib\Base\Component
{
    ...
    public static function linkStyles()
    {
        if (
            ...
            wp_enqueue_style( 'bookly-ladda.min.css', $bookly . '/frontend/resources/css/ladda.min.css', array(), $bookly_ver );
            wp_enqueue_style( 'bookly-customer-profile.css', $pro . '/frontend/modules/customer_profile/resources/css/customer-profile.css', array(), $plugin_ver );
        }
    }
    ...
    public static function linkScripts()
    {
        if (
            ...
            wp_enqueue_script( 'bookly-spin.min.js', $bookly . '/frontend/resources/js/spin.min.js', array(), $bookly_ver );
            wp_enqueue_script( 'bookly-ladda.min.js', $bookly . '/frontend/resources/js/ladda.min.js', array( 'bookly-spin.min.js' ), $bookly_ver );
            wp_enqueue_script( 'bookly-customer-profile.js', $pro . '/frontend/modules/customer_profile/resources/js/customer-profile.js', array( 'jquery' ), $plugin_ver );
